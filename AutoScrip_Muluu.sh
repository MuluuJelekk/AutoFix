...
# yeah
wget -O user-list https://raw.githubusercontent.com/MuluuJelekk/AutoFix/master/user-list
if [ -f user-list ]; then
	mv user-list /usr/local/bin/
	chmod +x /usr/local/bin/user-list
fi

wget -O menu https://raw.githubusercontent.com/MuluuJelekk/AutoFix/master/menu
if [ -f menu ]; then
	mv menu /usr/local/bin/
	chmod +x /usr/local/bin/menu
fi

wget -O monssh https://raw.githubusercontent.com/MuluuJelekk/AutoFix/master/monssh
if [ -f monssh ]; then
...
# info
clear
echo "MuLuu09 | @MuLuu09| MuLuu | 7946F434" | tee log-install.txt
